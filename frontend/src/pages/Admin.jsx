    ...
    <div className="min-h-screen bg-neutral-950 text-gray-100">
      ...
      <div className="max-w-lg mx-auto px-4 py-16">
        ...
        <div className="mb-8">
          ...
          <p className="text-xs text-neutral-600 ml-11">Upload news video for blockchain-authenticated streaming</p>
        </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 shadow-2xl shadow-black/40 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <label className={`flex items-center gap-4 w-full bg-neutral-800 border border-dashed rounded-xl px-4 py-4 cursor-pointer transition ${
          ...
          {stage === "processing" && (
            <div className="bg-neutral-800/60 border border-neutral-700/60 rounded-xl p-4 space-y-3">
              ...
              <div className="space-y-2">
                {steps.map((step, i) => (
                  <div key={i} className={`flex items-center gap-2.5 text-xs transition-all ${
                    step.done ? "text-emerald-400" : step.active ? "text-yellow-400" : "text-neutral-600"
                  }`}>
                    {step.done ? (
                      <span className="w-3.5 h-3.5 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center text-[9px] flex-shrink-0">✓</span>
                    ) : step.active ? (
            ...
            <div className="space-y-4">
              <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2">
                  <span className="w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-xs">✓</span>
